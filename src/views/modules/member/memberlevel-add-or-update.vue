  ...
  >
    ...
    >
      ...
      <el-form-item label="默认等级" prop="defaultStatus">
        <el-checkbox v-model="dataForm.defaultStatus"></el-checkbox>
      </el-form-item>
      ...
      <el-form-item label="是否有免邮特权" prop="priviledgeFreeFreight">
        <el-checkbox v-model="dataForm.priviledgeFreeFreight"></el-checkbox>
      </el-form-item>
      <el-form-item label="是否有会员价格特权" prop="priviledgeMemberPrice">
        <el-checkbox v-model="dataForm.priviledgeMemberPrice"></el-checkbox>
      </el-form-item>
      <el-form-item label="是否有生日特权" prop="priviledgeBirthday">
        <el-checkbox v-model="dataForm.priviledgeBirthday"></el-checkbox>
      </el-form-item>
        ...
        if (this.dataForm.id) {
          this.$http({
            ...
            if (data && data.code === 0) {
              ...
              this.dataForm.defaultStatus = data.data.defaultStatus || false;
              ...
              this.dataForm.priviledgeFreeFreight =
                data.data.priviledgeFreeFreight || false;
              this.dataForm.priviledgeMemberPrice =
                data.data.priviledgeMemberPrice || false;
              this.dataForm.priviledgeBirthday =
                data.data.priviledgeBirthday || false;
